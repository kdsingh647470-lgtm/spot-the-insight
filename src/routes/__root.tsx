...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Spot the Difference AI" },
      { property: "og:description", content: "Find hidden differences across AI-generated worlds. Daily challenges, timed mode, and endless levels." },
